  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        {/* Estado de Loading do userId */}
        {!userId && (
          <div className="flex justify-center items-center py-12">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#003194]"></div>
            <span className="ml-3 text-lg text-gray-600">Verificando autenticação...</span>
          </div>
        )}

        {/* Estados de Loading e Erro das reservas */}
        {userId && loading && (
          <div className="flex justify-center items-center py-12">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#003194]"></div>
                    ...
                    <div key={travel.id} className="flex flex-col overflow-hidden rounded-lg shadow-md bg-white w-80">
                      ...
                      <div className="flex-grow p-4 pt-0">
                        <div className="flex items-center justify-between">
                          <span
                            className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${travel.status === "finished"
